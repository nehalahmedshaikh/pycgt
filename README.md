...
- **CGSuite** — canonical forms, temperatures and means of Domineering 2×n
  boards, generated by driving CGSuite 2.2 beta 2 headlessly.
...
- **No atomic weights.** The atomic weight of *G* is the unique *W* with
  ...
  *Winning Ways*' two-ahead rule, and reconstructing that from memory is the
  ...
  Norton product it is defined against is here, and `tools/cgsuite` provides a
  headless driver for querying the reference values.
